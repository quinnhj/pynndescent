...
@numba.njit(parallel=True, locals={"idx": numba.types.int64}, nogil=True)
...
@numba.njit("b1(u1[::1],i4)", nogil=True)
...
@numba.njit("void(u1[::1],i4)", nogil=True)
...
@numba.njit(locals={"p": numba.types.int64, "q": numba.types.int64}, nogil=True)
